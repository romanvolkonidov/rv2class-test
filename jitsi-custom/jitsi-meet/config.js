...
var config = {
    ...
    hosts: {
        ...
        // authdomain: 'app.rv2class.com',

        // Focus component domain. Defaults to focus.<domain>.
        // focus: 'focus.app.rv2class.com',

        // XMPP MUC domain. FIXME: use XEP-0030 to discover it.
        muc: 'conference.' + subdomain + 'app.rv2class.com',
    },

    // BOSH URL. FIXME: use XEP-0156 to discover it.
    bosh: 'https://app.rv2class.com/' + subdir + 'http-bind',

    // Websocket URL (XMPP)
    websocket: 'wss://app.rv2class.com/' + subdir + 'xmpp-websocket',

    // websocketKeepAliveUrl: 'https://app.rv2class.com/' + subdir + '_unlock',
    ...
    /*
     * SUGGESTION: Enable prejoin + lobby behavior
     * ------------------------------------------
     * If you want the default Jitsi prejoin (camera/mic preview) and
     * lobby (knocking/waiting room) UX enabled on the server side, you
     * can uncomment/apply the following options in this file on the server
     * and then reload the web bundle / restart jicofo + jitsi-videobridge:
     *
     *   enableWelcomePage: true,
     ...
     *   }
     *
     * Note: this repo contains frontend code that can also opt-in to
     * the Jitsi lobby via the External API. The frontend has been updated
