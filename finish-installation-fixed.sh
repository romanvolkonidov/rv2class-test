...
# Fixed installation script with proper dependency handling
...
echo "romanvolkonidov@gmail.com" | /usr/share/jitsi-meet/scripts/install-letsencrypt-cert.sh
...
sed -i "s|// p2p: {|p2p: {\n        enabled: true,\n        stunServers: [\n            { urls: 'stun:jitsi.rv2class.com:3478' },\n            { urls: 'stun:stun.l.google.com:19302' }\n        ]\n    },\n    // OLD_p2p: {|" /etc/jitsi/meet/jitsi.rv2class.com-config.js
...
SSH Command:
  sshpass -p 'eG7[89B2tgdJM=t2' ssh root@${EXTERNAL_IP}
...
systemctl restart prosody jicofo jitsi-videobridge2 coturn
...
echo ""
echo "After DNS propagates (5-10 minutes):"
echo "  1. Test: https://jitsi.rv2class.com"
echo "  2. I'll update your JitsiRoom.tsx"
echo "  3. We'll deploy to Vercel"
echo ""
echo "Server Details:"
echo "  IP: 207.246.95.30"
echo "  Password: eG7[89B2tgdJM=t2"
echo ""
